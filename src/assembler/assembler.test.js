...
it("assembles Max program correctly", () => {
  expect(assemble(ADD_ASM)).toEqual(ADD_HACK);
});

it("assembles Max program correctly", () => {
  expect(assemble(MAX_ASM)).toEqual(MAX_HACK);
});

it("assembles Rect program correctly", () => {
  expect(assemble(RECT_ASM)).toEqual(RECT_HACK);
});

it("assembles Pong program correctly", () => {
  expect(assemble(PONG_ASM)).toEqual(PONG_HACK);
});
